 ...
 * CONSTANTS
*/
const MODAL_TOGGLE = 'WIDGET_EDITOR/MODAL_TOGGLE';
const MODAL_SET_OPTIONS = 'WIDGET_EDITOR/MODAL_SET_OPTIONS';
const MODAL_LOADING = 'WIDGET_EDITOR/MODAL_LOADING';
const MODAL_EXECUTE_CLOSE_CALLBACK = 'WIDGET_EDITOR/MODAL_EXECUTE_CLOSE_CALLBACK';
